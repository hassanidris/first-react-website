...
const Header = () => (
  ...
  <div className='mb__header_info'>
    ...
    <p className='p__opensans' style={{width: '80%'}}>Sit tellus lobortis sed senectus vivamus molestie. Condimentum volutpat morbi facilisis quam scelerisque sapien. Et, penatibus aliquam amet tellus </p>
